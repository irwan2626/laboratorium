...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Asisten Laboratorium'); ?></title>
    <style>
        :root {
            --background: #f9f9ff;
            --surface: #f9f9ff;
        ...
        <aside class="sidebar">
            <div class="brand">
                ...
                <div class="account-box">
                    <span>Akun</span>
                    <strong><?php echo e(auth()->user()->name ?? 'Asisten'); ?></strong>
                </div>
            </div>

            <div class="mobile-menu-panel">
                <nav class="menu">
                    <a href="/asisten/dashboard" class="<?php echo e(request()->is('asisten/dashboard') ? 'active' : ''); ?>">Dashboard</a>
                    <a href="/scan" class="<?php echo e(request()->is('scan') ? 'active' : ''); ?>">Scan QR Kerusakan</a>
                    <a href="/data-kerusakan" class="<?php echo e(request()->is('data-kerusakan') ? 'active' : ''); ?>">Lihat Data Kerusakan</a>
                </nav>
...
<?php /**PATH C:\laragon\www\pendataan_labor\resources\views/layouts/asisten.blade.php ENDPATH**/ ?>
    ...
    <div class="admin-shell">
        ...
        <aside class="sidebar">
            <div class="brand">
                ...
                <p><?php echo e(auth()->user()->name ?? 'Admin'); ?></p>
            </div>

            <div class="mobile-menu-panel">
                <nav class="menu">
                    <a href="/admin/dashboard" class="<?php echo e(request()->is('admin/dashboard') ? 'active' : ''); ?>">Dashboard Utama</a>
                    <a href="<?php echo e(route('admin.laboratorium.index')); ?>" class="<?php echo e(request()->is('admin/laboratorium') ? 'active' : ''); ?>">Kelola Data Laboratorium</a>
                    <a href="<?php echo e(route('users.index')); ?>" class="<?php echo e(request()->is('users*') ? 'active' : ''); ?>">Kelola Data User</a>
                </nav>
...
<?php /**PATH C:\laragon\www\pendataan_labor\resources\views/layouts/admin.blade.php ENDPATH**/ ?>